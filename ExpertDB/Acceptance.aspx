<%@ Page Title="" Language="C#" MasterPageFile="~/ExpertDB/Expert.Master" AutoEventWireup="true" CodeBehind="Acceptance.aspx.cs" Inherits="REP.ExpertDB.Acceptance" %>
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <div class="div_Form card">
                    ...
                    <h5 class="field-label-13">إذا كنت قادر على تقديم الاستشارة ضع السعر</h5>
                    <h5 class="field-label-13">سعر الاستشارة:</h5>
                    <asp:TextBox Enabled="true" CssClass="form-control" ID="TextBox5" runat="server"></asp:TextBox>
