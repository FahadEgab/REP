<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="forget.aspx.cs" Inherits="REP.forget" %>
    ...
    <div class="container" style="margin-top: 8rem; height:77vh;" dir="rtl">
        <div class="row">
            ...
            <div class="col-md-8" style="padding: 4%;">
              <h1 style="text-align: center;">إجراءات تغيير كلمة المرور</h1>  
              
              
              <h5>ادخل البريد الالكتروني:</h5>  
                <asp:TextBox ID="TextBox1" runat="server" CssClass="form-control" TextMode="Email"></asp:TextBox>
              
             <asp:Label Style="text-align: center;" ID="Label1" runat="server" Text="" ></asp:Label>
              
               <asp:Button ID="Button1" Style="float: left; margin-top: 1rem;" runat="server" Text="إرسال" CssClass="btn btn-success" OnClick="Button1_Click" />
