<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="change.aspx.cs" Inherits="REP.change" %>
    ...
    <div class="container" style="margin-top: 8rem; height:77vh;" dir="rtl">
        <div class="row">
            ...
            <div class="col-md-8" style="padding: 4%;">
              <h1 style="text-align: center;">تغيير كلمة المرور</h1>  
              
              
              <h5>الرمز المرسل على الايميل:</h5>  
                <asp:TextBox ID="TextBox1" runat="server" CssClass="form-control"></asp:TextBox>
              
              <h5>كلمة المرور الجديدة:</h5>

                    <asp:TextBox ID="TextBox2" runat="server" CssClass="form-control" TextMode="Password"></asp:TextBox>
                <h5>ادخل كلمة المرور الجديدة مرة اخرى:</h5>
              ...
              <a href="forget.aspx" style="text-align: center;"><h5>هل نسيت كلمة المرور؟</h5></a>
               ...
               <asp:Button ID="Button1" Style="float: left; margin-top: 1rem;" runat="server" Text="تغيير" CssClass="btn btn-success" OnClick="Button1_Click1"  />
